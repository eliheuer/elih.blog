...
At the direct end: bureaucracy, gatekeeping, permissions, managerial overhead, funding politics, user hostile licensing, and complex IP law.

At the diffuse end: disorganazation, coordination failure, infighting, extreamist politics, burnout, and a lack of incentives.

## 2 Thought Experiment

Imagine two people, Alice and Bob. They both work 30 hours per week at a similar task creating some kind of digital good. They are both trying to capture value from this activity in various forms like money and/or social capital.
...
| Capture rate   | 90 %  | 10 %|
| Value captured | <span style="color: #ef4444">9</span> | <span style="color: #22c55e">10</span> |
...
For most of human history, value capture for cultural production was largely diffuse. People wrote stories based on other stories. They sang songs that were variations of other songs.

Before the invention of the printing press, A poet would write a poem and share it with people. If someone liked it, they would share it with other people.

A scribe would make a copy as a manuscript and sell it without permission of the author. This would help the scribe capture value from their craft and the poet would capture value in other ways such as patronage, teaching jobs, or talks and lectures.

The scribe copying the manuscript would help the poet because copying was so difficult and time consuming that every new copy made would significantly increase the likelihood of patronage for the poet. The ideas and norms around intellectual property at the time were directly influenced by the current level of technology and automation for copying information.
...
|------|--------------|--------------------|---------------------|
| **c. 1450** | Gutenberg's movable-type press | Explosion of vernacular Bibles, pamphlets; authorities panic over heresy. | *None yet* – copying suddenly cheap, rules nonexistent. |
| **1476** | Caxton sets up England's first press | Crown issues ad-hoc printing patents, but enforcement patchy. | Still *no copyright*—control via favors & guilds. |
| **1517** | Luther's Ninety-five Theses | Printed and distributed across Europe; sparks Reformation. | Demonstrates power of print to bypass traditional gatekeepers. |
...
| **1662** | Licensing Act renewed | Censorship tightens; printers need a license or face seizure. | Parliament grows wary of monopoly but has no alternative. |
| **1695** | Licensing Act lapses | *14-year vacuum*—anyone may print; pamphlet culture booms. | Chaos forces MPs to rethink "who owns a text?" |
| **1710** | **Statute of Anne** | For the first time, *authors*, not printers, receive a 14-year exclusive right. | Birth of modern copyright—arrives **≈250 yrs after the press**. |

Critics of capitalism often see direct value capture as inherent to capitalism, but I suspect it is more tied to the current level of technology and automation, and today due to the aforementioned cultural lag behind technology.

{/*
In a free market your margin is someone else's opportunity, and there is an endless supply of people that are willing to let some value go uncaptured in order to challenge a stagnant incumbent in the market.
*/}
...
Art, music, code, design, and other cultural products, culled from the open web, are diffused across latent space. The output is at once everyone and no one—impossible to decompose into source pixels that a rightsholder can use direct value capture on. Latent diffusion turns this into a phase-change problem: solids (individual works) melt into air (weight vectors).

Once creativity is encoded as a multi-trillion-parameter fog, the idea that you can meter each droplet of inspiration the way you meter a DVD sale becomes economically and technically incoherent.
...
A need for diffuse value capture systems is a direct consequence of technological trends:
