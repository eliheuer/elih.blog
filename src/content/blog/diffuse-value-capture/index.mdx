...
I'm interested in the idea of post-authorship and how it relates to the idea of free and open source software, specifically in the context of copyleft licenses like the VPL, GPL, and the OFL. Is it possible to use crypto incentives to build large scale collabrative open source projects that use more diffuse value capture strategies? The main thing holding back this kind of work is financial incentive as far as I can tell. Many programmers and designer are financially incentivised to work in corprate settings on large project they have little authorship over. What if we could partially recreate those incentives in permissionless independent open-source projects?

Outside of crypto an example I often use to illlustate this idea is open-source fonts. Designers selling proprietary fonts with complicated and expensive licensing are classic dirrect value capture projects, similar to Alice they try to captture 90%-100% of the value created. This direct value capture strategy leads to extreme beliefs about authorship and originality that are often post-rationalized after the financial incentive was known, when in reality, the design of fonts is extremely memetic and every design is a remix of other designs. A truly unique font design that isn't built on a mountain of prior work and free and open-source software is almost impossible to find. And will become almost impossible to find as AI tools for font design get better.
...
Incentives are not abolished; they are rewired. The greatest rewards accrue to behaviors that expand the commons instead of enclosing it. Work speaks louder than claims of authorship, and no single actor can monopolize the surplus without the community’s consent.
...
The emerging landscape resembles a coral reef: countless small actors competing and cooperating at the edge while collectively building something vast, intricate, and durable. Anything whose marginal cost has collapsed—can flourish under this model.
