...
Published May 8th, 2025 (draft: under construction)
...
At the direct end, you have bureaucracy, gatekeeping, permissions, managerial overhead, corporate politics, complex and user hostile licensing and IP law.

At the diffuse end, disorganazation, coordination failure, extreamist politics, burnout, and a lack of incentives.

## 2 Thought Experiment

Imagine two people, Alice and Bob. They both work 30 hours per week at a similar task creating some kind of digital good. They are both trying to capture value from this activity in various forms like money and/or social capital. Alice and Bob each have different strategies for distribution, intellectual property licensing, and production, as well as different cultural views around originality and authorship in their craft. 
...
Following these unique strategies, Alice creates 10 units of value, and captures 9, almost all the value. Bob creates 100 units of value, but only captures 10. Alice captures 90% of the value created, and Bob captures 10%, but Bob still captures slightly more value than Alice—one whole unit—with the same amount of work.

## 3 Authorship & Originality are Diffuse

For the most part, IP law, corporate culture, and traditional finance are still skewed towards direct value capture, but recent advancements in AI are starting to exacerbate longstanding flaws in the current mainstream IP system and direct value capture strategies. LLMs are diffuse in nature, direct value capture does not map well onto them. 

It didn't even map well to the complexity and diffuse nature of cultural production on the internet before the current AI hype cycle, but now these flaws have been pushed to the point where they are becoming undeniable.
...
Diffuse value capture is likely to increase in relevance in the future because it's a direct consequence of technological trends:
...
4. Crypto: internet-native programmable hard money as a diffuse value capture tool.
...
The scribe copying the manuscript would help the poet because copying was so difficult and time consuming that every new copy made would significantly increase the likelihood of patronage, social capital, and other forms of value capture for the poet. The ideas and norms around intellectual property at the time were directly influenced by the current level of technology and automation for copying information.

Since the invention of the printing press, value capture for cultural production has mostly become more direct. Culminating in the pre-internet era of Hollywood, the music industry, and publishing, and the army of bureaucrats and lawyers required to keep those industries running.
...
Critics of capitalism often see direct value capture as inherent to capitalism, but I suspect it is more tied to the current level of technology and automation, and today due to the aforementioned cultural lag behind technology. In a free market your margin is someone else's opportunity, and there is an endless supply of people that are willing to let some value go uncaptured in order to challenge a stagnant incumbent in the market, if technology and automation allow for enough value capture to survive.

Things like S&P 500 ETFs and the Boglehead investing strategy can be seen as primitive forms of diffuse value capture fully aligned with mainstream capitalism. It's a way to diffusely capture value from the economy with minimal bureaucracy and middlemen.

{/*
Marx himself I think saw the potential for diffuse value capture in advanced capitalism. Much of the failures of the Left can be seen as a result of the tyranny and bureaucracy required by trying to solve the problems created by direct value capture with more direct value capture and transfer.
...
Even among programmers, there is currently a misalignment between value creation and value capture. Bill Gates' net worth is many times greater than Linus Torvalds, Richard Stallman, etc, and at least in my opinion, the latter have provided significantly more value to computing and the world.

Free and open-source software culture outside of crypto has been unable to develop effective value capture and coordination systems, and has largely been relegated to controlled opposition and pawns in commoditize-your-complement schemes. Despite anti-consumer behavior from big tech incumbents, free and open-source software mostly can't compete with proprietary alternatives, with some exceptions like Blender. But even Blender feels massively under resourced for the amount of value it creates.
...
## 6 Crypto: Open-Source Programable Internet-Native Hard Money
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">The ad model unlocked free information for users within closed platforms with opaque algorithms.<br><br>The coin model unlocks free information for users available to any platform and uses open markets.</p>&mdash; jacob (@js_horne) <a href="https://twitter.com/js_horne/status/1920940129876664578?ref_src=twsrc%5Etfw">May 9, 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
