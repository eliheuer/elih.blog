...
The direct end has: bureaucracy, gatekeeping, permissions, managerial overhead, funding politics, user hostile licensing, metrics fixation, and complex IP law.
...
For most of human history, cultural production was largely diffuse. People wrote stories based on other stories. They sang songs that were variations of other songs. Authorship and originality were diffuse.

Observe an artclass for young children and you will rarly see them sign their work, this behavior is almost allways done at the suggestion of an adult.
...
Auctor (Latin root of “author”) meant someone who added authority to a text, not necessarily its sole creator. Most works circulated anonymously or under famous names to lend prestige. Almost certianly, ancint history is full of creative original thinkers who were erased from history by authors who were better at self promotion and distribution.

Since the European invention of the printing press, cultural production has mostly become more direct. Culminating in the pre-internet era of Hollywood, TV, the music industry, and publishing. 
...
## 4 Neo-China Arives from the Future
...
The diffuse-to-direect spectrum shifts regionally. The Far East has longstanding cultural diffenences in views of authorship and originality that are not purely due to avaible technology. The Chinese idea of the original is determined not by a unique act of creation, but by unending process, not by definitive identity but by constant change. Skillful reference signalls erudition; originality is in nuanced re-combination, not radical newness.
...
In late 2024 DeepSeek-AI quietly open-sourced DeepSeek LLM 7B/67B, trained from scratch on a 2-trillion-token bilingual corpus and already edging past Llama 2 70B on code and reasoning tasks.
 
By early 2025 it followed with DeepSeek R1/R2, a 671-billion-parameter mixture-of-experts model that reaches GPT-4-class performance while running on commodity Chinese silicon and a training budget of roughly $5-6 million—two orders of magnitude below U.S. flagships. 

DeepSeek's prenence on GitHub and HuggingFace is as striking as its benchmark scores. The effect is classic shanzhai: once the weights hit the torrent networks, dozens of regional forks sprang up—Indonesian, Arabic, Urdu—patched for local idioms. The cost-to-copy a frontier model has collapsed to the price of downloading 100 GB, and every copy invites further improvement.

Western incumbents still cling to a direct value-capture mindset—API call metering, secret weights, NDAs—while Chinese labs treat the model itself as advertising for downstream services, hardware, prestige, and alpha for their AI quant funds.

DeepSeek is a prime example of diffuse value capture. It channels centuries of permissive reuse ethos into the hottest technology in the world—and it arrives just as American IP maximalists and saftyist lose the plot.

The specter of a “Chinese century” is therefore not just about GDP or rare-earth supply chains; it’s about an ideological wedge between open-source abundance and closed-source scarcity. If the most capable models are the most forkable, the center of gravity for cultural production may shift eastward by default, carried on the BitTorrent swarm of model checkpoints rather than container ships of plastic toys.

{/*
Critics of capitalism often see one-to-many direct culture as inherent to capitalism, and many-to-many diffuse culture as communist, but I suspect capitalism's prefrance for direct or diffuse culture is more tied to the current level of technology and automation, and today due to the aforementioned cultural lag behind technology. In a free market your margin is someone else's opportunity, and in the absense of govenment intervention there is an endless supply of people that are willing to let some value go uncaptured in order to challenge a stagnant incumbent in the market.
