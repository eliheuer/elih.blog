...
Adjuctive—Widely spread out rather than concentrated; dispersed across many points, participants, or locations.

Verb—To spread or cause to spread broadly, so that no single node, owner, or point of exchange controls the whole.
...
Free software—and its softer rebrand, open source—has powered computing for decades; you can’t boot a phone or load a webpage without it. Living inside this commons has taught programmers to embrace diffuse value capture, while many neighbouring professions still cling to the 20th-century model of direct, author-centric ownership.
...
The incentives and coordination mechanisms requered to compete with the Apples and Nvidias of the world seem to be missing. One exception being cyrpto curancies, which are open-source and diffuse by nature, but remain controvercial in many free and open-source circles.
