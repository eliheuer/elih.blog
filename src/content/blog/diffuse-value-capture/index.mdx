...
Alice captures 90% of the value created, and Bob captures 10%, but Bob still captures slightly more value than Alice with the same amount of work. When you become too obsessed with capturing all the value you create, the product, idea, or service you are working on becomes too user hostile to be useful, and a compeditor will ususly be willing to capture less value in the short term to get a foothold in the market. 

Most IP law, corporate culture, and traditional finance asset formation is skewed towards the direct value capture end of the spectrum, but recent advancments in AI are starting to show the flaws in this model. Direct value capture requiers a lot of bureaucracy to maintain, and LLMs are diffuse in nature. The more complex a system, the more difficult it is to maintain a culture of direct value capture, this is the noproductive activity Richard Stallman laments at the end of the GNU Manifesto.
