...
description: 'Thoughts on incentivizing post-authorship commons-based peer production by means of crypto and AI.'
...
Thoughts on incentivizing post-authorship commons-based peer production by means of crypto and AI.
...
Imagine two people, Alice and Bob. They both work 40 hours per week at a similar task—some kind of digital information product—trying to capture value in various forms like money and social capital. They each have diffrent staregies for distribution, intelectual property licensing, and production as well as differnt cultural views around originality and authorship in their craft. 

Folowing these unique strategies, Alice creates 10 units of value, and captures 9, almost all the value. Bob creates 100 units of value, but only captures 10. Alice captures 90% of the value created, and Bob captures 10%, but Bob still captures slightly more value than Alice with the same amount of work.
...
Most IP law, corporate culture, and traditional finance asset formation is skewed towards direct value capture, but recent advancments in AI are starting to exasterbate longstanding flaws in these models. LLMs are diffuse in nature, direct value capture strageies don't map well onto them or even just the complexity of cultural production on the internet.

Listen to conversations about AI and intelectual property and you will see there is very little consensuse on how to contine the current IP system in this new AI era. Calls for radical reforms to the current IP system that used to be relegated to the lunatic fringe are gaining traction is mainstream tech circles.
...
At the crest of this wave of direct value capture, the personal computer was developed, and planted the seeds for a cultural shift back towards diffuse value capture. Not as a return to the pre-industrial models of diffuse value capture, but as new hyper-financialized ways to capture value that are only possible with decentralized global computer networks.

Remember that culture lags behind technology, there was a 250 year gap between the invention of the printing press and what we now recognize as contemporary IP law and ideas about authorship and originality. So while timelines for cultural shifts are getting shorter, there is still a lag and we have seen certains trends more towards direct value capture even as momentum towards diffuse value capture is slowly growing.

Critics of capitalism often see direct value capture as inherant to capitalism, but I suspect it is more tied to the curent level of technology and automation, and today due to culture lagging behind technology. In a free market your margin is someone else's opportunity, and there is an endless supply of people that are willing to let some value go uncaptured in order to chanlange a stagnant incumbant in the market. Things like S&P 500 ETFs and the Bogglehead investing strategy can be seen as blunt primative forms of diffuse value capture aligned with capitalism.

{/*
Marx himself I think saw the potental for diffuse value capture in adnanced capitalism. Much of the failures of the Left can be seen as a result of the tyrany and burocracy requied by direct value capture models.
